 classdef Blowfish
    ...
    methods
        ...
        function [obj] = InitializeBlowfish( obj , key , keybytes)
            j=1;
            n = obj.N;
            hex1 = hex2dec('00000000FFFFFFFF');
            hex2 = hex2dec('FFFFFFFF00000000');
            for i = 1:n+2
